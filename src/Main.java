...
//	private static final int[] TAMANHOS_CONJUNTO_DADOS = {20_000, 100_000, 500_000, 1_000_000, 5_000_000};
	private static final int[] TAMANHOS_CONJUNTO_DADOS = {20000};
	...
	public static void main(String[] args) {	
		...
		System.out.print("\t\t\tQuantidade de registros com pelo um dígito sendo zero: " + 
	...
	private static void realizarTestesEmTabelasHashPorCalculadoraHashEspecifica(CalculadoraHash calculadoraHash) {
		...
		for (int i = 0; i < obterTamanhoVetor(TAMANHOS_VETOR_TABELA_HASH); i++) {
			...
			for (int j = 0; j < obterTamanhoVetor(TAMANHOS_CONJUNTO_DADOS); j++) {
				...
				System.out.println("\t\tDados obtidos para inserção de " + TAMANHOS_CONJUNTO_DADOS[j] + " dados:");
				...
				System.out.println("\t\t\tQuantidade de operações de comparação na lista após colisão: " + 
						tabelaHash.obterQtdComparacoesInsercao());
				System.out.println("\t\t\tQuantidade de elementos da pilha mais cheia: " + 
						tabelaHash.buscarQtdRegistrosPilhaMaisCheia());
				System.out.println("\t\t\tQuantidade de elementos da pilha mais vazia: " + 
